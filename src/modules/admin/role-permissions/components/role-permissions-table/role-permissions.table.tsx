...
import { RolePermissionsFilter } from "./role-permissions-filter.table";
...
interface RolePermissionsTableProps {
  columns: ColumnDef<IRolePermissions>[];
  data: IRolePermissions[];
  onDelete: (rows: Row<IRolePermissions>[], callback: () => void) => void;
  totalItems: number;
  currentPage: number;
  itemsPerPage: number;
            ...
            {isLoading ? (
              ...
              table.getRowModel().rows.map((row) => (
                <TableRow
                  ...
                  onClick={() => setActiveRowId(row.original.roleId)}
                  className={`cursor-pointer transition-colors ${
                    activeRowId === row.original.roleId
