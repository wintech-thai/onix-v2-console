...
import { apiKeySchema, ApiKeySchemaType } from "../../schema/apikey.schema";
...
export const ApiKeyForm = ({
  ...
  const handleSubmit = async (values: ApiKeySchemaType) => {
    if (!isDirty) {
      return router.back();
    }
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 p-4 space-y-4 overflow-y-auto">
            ...
            <Controller
              ...
              render={({ field }) => {
                return (
                  <Input
                    {...field}
                    label={t("form.keyInformation.keyName")}
                    isRequired
            ...
            <Controller
              ...
              render={({ field }) => {
                return (
                  <Input
                    {...field}
                    label={t("form.keyInformation.keyDescription")}
                    isRequired
                    errorMessage={errorMessageAsLangKey(
                      errors.keyDescription?.message,
                      t
                    )}
                    maxLength={500}
        ...
        {/* API Key Roles Section */}
        <div className="p-4 md:p-6 border rounded-lg">
          <header className="text-lg font-bold">
            {t("form.keyRoles.title")}
          </header>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>{t("form.keyRoles.availableRoles")}</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {availableRoles.length === 0 ? (
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>{t("form.keyRoles.selectedRoles")}</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {selectedRoles.length === 0 ? (
