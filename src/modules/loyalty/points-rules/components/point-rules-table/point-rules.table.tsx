...
import { PointRuleFilterTable } from "./point-rules-filter.table";
import {
  Select,
  SelectContent,
  SelectItem,
...
export function PointRulesTable<TData, TValue>({
  columns,
  data,
  onDelete,
  totalItems,
  ...
  const { activeRowId, setActiveRowId } = useActiveRow("point-rule-table");
