...
import { PrivilegesFilterTable } from "./privileges-filter.table";
import {
  Select,
  SelectContent,
  SelectItem,
...
export function PrivilegesTable<TData, TValue>({
  columns,
  data,
  onDelete,
  totalItems,
  ...
  const { activeRowId, setActiveRowId } = useActiveRow("privileges-table");
