...
interface PrivilegesFilterTableProps {
  onDelete: () => void;
  isDisabled: boolean;
...
export const PrivilegesFilterTable = ({
  onDelete,
  isDisabled,
  onSearch,
  selected,
}: PrivilegesFilterTableProps) => {
  ...
  return (
    <form
      ...
      "
      aria-label="Privileges filter controls"
    >
      ...
      <Link
        ...
        href={RouteConfig.LOYALTY.PRIVILEGES.CREATE(params.orgId)}
      >
        {t("filter.add")}
      </Link>
      <div
