...
interface VoucherFilterTableProps {
  onDelete: () => void;
  isDisabled: boolean;
...
export const VoucherFilterTable = ({
  onDelete,
  isDisabled,
  onSearch,
  selected,
}: VoucherFilterTableProps) => {
  ...
  return (
    <form
      ...
      "
      aria-label="Voucher filter controls"
    >
      ...
      <div
        ...
        "
      >
        <Link href={RouteConfig.LOYALTY.VOUCHERS.CREATE(params.orgId)}>
