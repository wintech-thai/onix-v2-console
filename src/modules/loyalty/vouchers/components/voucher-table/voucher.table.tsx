...
import { VoucherFilterTable } from "./voucher-filter.table";

interface VoucherTableProps {
  columns: ColumnDef<IVoucher>[];
  data: IVoucher[];
  onDelete: (rows: Row<IVoucher>[], callback: () => void) => void;
  totalItems: number;
  currentPage: number;
  itemsPerPage: number;
...
export function VoucherTable({
  ...
  const { activeRowId, setActiveRowId } = useActiveRow("voucher-table");
