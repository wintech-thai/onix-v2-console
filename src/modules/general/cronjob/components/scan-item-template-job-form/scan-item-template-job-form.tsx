...
export interface ScanItemTemplateJobFormProps {
...
export const ScanItemTemplateJobForm = ({
  initialValue,
  isUpdate,
  onSubmit,
  cronJobData,
}: ScanItemTemplateJobFormProps) => {
  ...
  const getScanItemTemplate =
    getScanItemsTemplatesApi.useGetScanItemsTemplates(params);
  ...
  if (!templatePayload) {
    throw new Error("ScanItemTemplate Not Found");
  }
