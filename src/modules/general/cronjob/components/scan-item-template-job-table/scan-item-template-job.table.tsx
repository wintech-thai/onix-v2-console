...
import { ScanItemTemplateJobFilterTable } from "./scan-item-template-job-filter.table";
import {
  Select,
  SelectContent,
  SelectItem,
...
export function ScanItemTemplateJobTable<TData, TValue>({
  columns,
  data,
  onDelete,
  totalItems,
  ...
  const { activeRowId, setActiveRowId } = useActiveRow("scan-item-template-job-table");
  ...
  return (
    <div className="h-full flex flex-col">
      <ScanItemTemplateJobFilterTable
